...
class CreateDataUpdateRequest extends Request
{
    ...
    public function rules()
    {
        return [
            ...
            'birth_municipality'        => 'required|alpha|max:80',
            'birth_country'             => 'required|alpha|max:80',
            'residence_municipality'    => 'required|alpha|max:80',
            'residence_address'         => 'required|max:100',
            'residential_area'          => 'required|alpha|max:100',
