...
class CreateDataUpdateRequest extends Request
{
    ...
    {
        return [
            'user_id'                   => 'required|exists:users,id|unique:data_updates,user_id',
            'identification'            => 'required|integer',
            'first_name'                => 'required|max:80',
            'last_name'                 => 'required|max:80',
            'birth_date'                => 'required|date|after:1935-01-01|before:2004-01-01',
            ...
            'one_phone'                 => 'required|integer|digits_between:7,10',
            'two_phone'                 => 'required|integer|digits_between:7,10|different:one_phone',
            ...
            'one_phone_family'          => 'required|integer|digits_between:7,10|different:one_phone|different:two_phone',
            'two_full_name_family'      => 'required|max:80',
            'two_relationship_family'   => 'required|max:80',
            'two_phone_family'          => 'required|integer|digits_between:7,10|different:one_phone|different:two_phone|different:one_phone_family',
        ];
    }
}
